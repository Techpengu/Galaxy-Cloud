...
<header>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            <div class="top-left">
                <div class="contact-area">
                    <span class="mr-35"><i class="las la-phone-volume"></i> <a href="tel:+91-9718070460">+91-9718070460</a></span>
                    <span><i class="las la-envelope"></i> 
                    <a href="mailto:info@galaxycloud.in"><span class="__cf_email__">info@galaxycloud.in </span></a></span>
                </div>
            </div>
            <div class="top-right">
    ...
    <div class="header-section bg-transparent sticky-xs">
        <div class="container-lg container-fluid d-flex justify-content-xl-between justify-content-start align-items-center">
            ...
            <ul class="main-menu d-flex align-items-center m-0 p-0">
                ...
                <li class="menu-item"><a href="" class="drop-down menu-link">Courses&nbsp;<i class="las la-angle-down"></i></a>
                    <ul class="submenu">
                        <li><a href="linux-training.php">Linux Training</a></li>
                        <li><a href="aws-training.php">AWS Cloud Training</a></li>
                        <li><a href="php-training.php">Php Training</a></li>
                        <li><a href="python-training.php">Python Training</a></li>
    ...
    <div class="mobile-menu">
        ...
        <ul class="m-0 p-0">
            ...
            <li class="moblie-item"><a href="services.php" class="moblie-link">Service</a></li>
