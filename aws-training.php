...
<head>
    <title>Galaxy Cloud | AWS Cloud Training</title>
    <?php include "include/css-url.php"; ?>
    
    <!-- Dynamic Meta Content -->
    <meta name="description" content="Build AWS Cloud Career with Galaxy Cloud, our Cloud training is based on industry projects that helps participant to get jobs in top MNC">
    <meta name="title" content="Galaxy Cloud | AWS Training">
    <meta name="keywords" content="AWS Cloud training in delhi, Industrail training on AWS in Noida, AWS Best Training Institute in Delhi, AWS Best Course Training in Delhi, AWS Training Institute">
    <meta name="url" content="https://galaxycloud.in/aws-training.php">
    ...
    <meta property="og:title" content="Galaxy Cloud | AWS Training">
    <meta property="og:url" content="https://galaxycloud.in/aws-training.php">
    <meta property="og:description" content="Build AWS Cloud Career with Galaxy Cloud, our Cloud training is based on industry projects that helps participant to get jobs in top MNC">
    ...
    <meta name="twitter:title" content="Galaxy Cloud | AWS Training">
    <meta name="twitter:url" content="https://galaxycloud.in/aws-training.php">
    <meta name="twitter:description" content="Build AWS Cloud Career with Galaxy Cloud, our Cloud training is based on industry projects that helps participant to get jobs in top MNC">
    <meta name="twitter:image" content="https://galaxycloud.in/img/favicon.png">

    <meta itemprop="name" content="Galaxy Cloud">
    <meta itemprop="url" content="https://galaxycloud.in/aws-training.php">
    <meta itemprop="description" content="Build AWS Cloud Career with Galaxy Cloud, our Cloud training is based on industry projects that helps participant to get jobs in top MNC">
                    ...
                    <main>
                        ...
                        <div class="cours-video mb-30">
                            <div class="video-popup2 video-popup">
                                <img src="images/courses/aws.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="tran_card">
                            ...
                            <div class="card-body">
                            <p class="para">You will be fully prepared for the AWS Certified Solutions Architect Associate, AWS Certified Developer Associate and AWS Certified SysOps Administrator Associate exams.</p>
                            </div>
                        </div>
                                            ...
                                            <div id="collapse11" class="accordion-collapse collapse"
                                                ...
                                                <ul class="lecture-list">
                                                        ...
                                                        <li
                                                            ...
                                                            <p class="lecture-title">Locations and the IP Address Ranges of Cloud <br> Front Edge Servers</p>
                                                        </li>
                                                        <li
                                                            class="d-flex flex-wrap justify-content-start align-items-center border-bottom3">
